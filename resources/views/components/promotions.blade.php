    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @forelse ($promotions as $promo)
                <div
                    class="relative bg-white rounded-xl border border-gray-200 p-6 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    {{-- Badge de descuento --}}
                    <div class="absolute top-4 right-4">
                        <span
                            class="inline-block bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-4 py-2 rounded-full transition">
                    ...
                    <div class="pb-4">
                        ...
                        <p class="text-gray-600 text-sm">{{ $promo->short_description }}</p>
                    </div>

                    <div>
                        <p class="text-sm text-green-600 font-medium mb-4">{{ $promo->validity_notes }}</p>
                        <a href="#contacto"
                            class="inline-block w-full text-center bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition">
