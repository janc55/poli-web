        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div>
                ...
                <div class="flex space-x-6">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=61571880335493"
                    target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Facebook"
                    class="text-gray-400 hover:text-blue-600 transition duration-300 transform hover:scale-110">
                        <svg viewBox="0 0 1920 1920" fill="currentColor" class="w-8 h-8">
                    ...
                    <a href="https://wa.me/59168310227"
                    target="_blank" rel="noopener noreferrer" aria-label="Contáctanos por WhatsApp"
                    class="text-gray-400 hover:text-green-500 transition duration-300 transform hover:scale-110">
                    ...
                    <a href="https://www.tiktok.com/@policonsultorio_unior"
                    target="_blank" rel="noopener noreferrer" aria-label="Síguenos en TikTok"
                    class="text-gray-400 hover:text-black transition duration-300 transform hover:scale-110">
